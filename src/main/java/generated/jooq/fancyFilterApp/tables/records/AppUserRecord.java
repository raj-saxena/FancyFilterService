 ...
 */
package jooq.fancyFilterApp.tables.records;
...
public class AppUserRecord extends UpdatableRecordImpl<AppUserRecord> implements Record11<UUID, String, Short, String, Short, UUID, String, BigDecimal, Short, Boolean, String> {
    ...
    private static final long serialVersionUID = 1286514872;
    ...
    /**
     * Setter for <code>public.app_user.city</code>.
     */
    public AppUserRecord setCity(UUID value) {
        set(5, value);
        return this;
    }

    /**
     * Getter for <code>public.app_user.city</code>.
     */
    public UUID getCity() {
        return (UUID) get(5);
    }
     ...
     */
    public AppUserRecord(UUID id, String displayName, Short age, String jobTitle, Short heightInCm, UUID city, String mainPhoto, BigDecimal compatibilityScore, Short contactsExchanged, Boolean favorite, String religion) {
        super(AppUser.APP_USER);
